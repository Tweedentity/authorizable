...
const AuthorizableLite = artifacts.require('./mocks/AuthorizableLiteMock.sol')


contract('AuthorizableLite', accounts => {
  ...
  before(async () => {
    authorizable = await AuthorizableLite.new()
  })
  ...
  it('should reset the default levels', async () => {
    await authorizable.authorize(authorizedLevel5, 0, {from: authorizedLevel114})
    await authorizable.deAuthorize({from: authorizedLevel114})
